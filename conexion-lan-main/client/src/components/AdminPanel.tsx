...
export function AdminPanel({
      ...
      <Card>
        ...
        <CardBody>
          <div className="text-sm text-slate-600">
            Abre la app en <span className="font-semibold">http://localhost:5173</span> para usar el
            panel Admin.
          </div>
        </CardBody>
      </Card>
  ...
  const appLink =
    net?.links?.app ?? (selectedAdvertise ? `http://${selectedAdvertise}:${net?.port}` : null)
        ...
        <CardBody>
          <div className="rounded-2xl border border-slate-200 bg-white/70 p-4">
            ...
            <div className="mt-3 text-xs text-slate-500">
              Tip: si el puerto que quieres esta en uso, elige otro (3001, 3005, 5050, 7001,
              9000...)
            </div>
